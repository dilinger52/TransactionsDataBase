...
public class TransManager {
    ...
    public double remittance(int transactionId, Timestamp date, String clientName, int currencyId, double rate,
        ...
        if (commission < 0 || commission > 100) throw new RuntimeException("Неверная величина комиссии. " +
                "Введите значение от 0 до 100 включительно");
        ...
        TransactionDto transactionDto = formatToDto(transactionId, date, currencyId, rate, commission, amount,
                transportation, client, balance, pibColor, amountColor, balanceColor);
    ...
    @Transactional
    public void update(int transactionId, String clientName, int currencyId, double rate, double commission,
                       double amount, double transportation) {
    ...
    private void updateNext(String clientName, List<Integer> currencyId, Double balanceDif,
        ...
        List<TransactionDto> transactionDtoList = transactionRepository
                .findAllByClientIdAndCurrencyIdInAndDateBetweenOrderByCurrencyIdAscDateAsc(
                        client.getId(), currencyId, newTransactionDto.getDate(),
    ...
    public void deleteTransaction(List<Transaction> transaction) {
        ...
        for (Transaction t : transaction) {
            ...
            updateNext(t.getClient().getPib(), currencyId, newBalance - oldBalance, transactionDto);
    ...
    private TransactionDto formatToDto(int transactionId, Timestamp date, int currencyId, double rate,
                                       ...
                                       double balance, String pibColor, String amountColor, String balanceColor) {
    ...
    public Transaction getTransactionByClientAndByIdAndByCurrencyId(int id, int clientId, int currencyId) {
        return formatFromDto(transactionRepository
    ...
    public void save(Transaction transaction) {
        transactionRepository.save(formatToDto(transaction.getId(), transaction.getDate(),
                ...
                transaction.getBalance(), transaction.getPibColor(), transaction.getAmountColor(),
